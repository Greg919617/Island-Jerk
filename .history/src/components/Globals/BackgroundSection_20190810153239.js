...
export default function BackgroundSection({
  ...
  return (
    ...
    <div className="home-inner container">
      ...
      <img  src="https://lh3.googleusercontent.com/6MxLRDs26bKuvVAHGrJxWdR1uVrXzAgB37OtoA-9ahoUjwdO5hkhQZjxB3eBtldh9cdA7wiBCw=w960-h960-n-o-v1" alt="image" class="center pb-1" alt="" class="center pb-1"/>
              </div>
            </div>
          </div>
        </div>
