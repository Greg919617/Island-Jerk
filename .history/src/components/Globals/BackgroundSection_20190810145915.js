     ...
     <div className="row">
       <div className="col col-4 col-lg-3">
         ...
         <div className="col col-4 col-lg-5">
           czxcz
         <img src="https://lh3.googleusercontent.com/6MxLRDs26bKuvVAHGrJxWdR1uVrXzAgB37OtoA-9ahoUjwdO5hkhQZjxB3eBtldh9cdA7wiBCw=w960-h960-n-o-v1" alt="image" class="center pb-1"/>
         </div>
         <div className="col col-4 col-lg-3">
                czxczx
         </div>
