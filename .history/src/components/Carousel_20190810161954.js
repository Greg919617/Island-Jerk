...
const Carousel= ({ data }) => (
    ...
    <MDBContainer>
    <MDBRow>
      <MDBCol className="squaresLeft mx-auto my-3"><p>Great Food  Serve only the highest quality product, prepare it in a clean and sparkling environment, and serve it in a warm and friendly manner. XzAgB37OtoA isad asdsf</p></MDBCol>
...
//     <div className="col-10 col-sm-8 col-md-6 col-lg-5 mx-auto my-3">
//     <MDBContainer>
...
//     <h1 className="d-inline">Drinks</h1>
